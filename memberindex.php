...
<div class="row well" id="panel">
    ...
    <span class="col-md-8 col-xs-8 text-right" id="welcome">
        <strong>Welcome Member :</strong> <span style="color: coral;"><?php echo $username ?></span>
    </span>
    <button class="btn custom-btn col-md-1 col-xs-1" id="register" onclick="location.href= './index.php';">Log Out</button>
</div>

<p id="username" hidden><?=$_SESSION['username'];?></p>
...
<script>
    ...
    function listMovies(str) {
        ...
        xmlhttp.open("GET","member_search.php?type="+str+"&username="+username,true);
        xmlhttp.send();
    }
</script>
</body>
